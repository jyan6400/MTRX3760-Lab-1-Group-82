...
int main()
{
  ...
  CHeater powerHeater( "PowerHeater" );
  powerHeater.TurnOn();
  powerHeater.SetTemperature( 70 );
  ...
  int heaterDraw = powerHeater.PowerDraw();
  std::cout << powerHeater.GetName() << ": " << heaterDraw << " W" << std::endl;
  total += heaterDraw;
